-- Migration: Add additional_images to get_recommendations
-- Date: December 19, 2025
-- Purpose: Enable image carousel in ProductCard for recommendations feed
...
RETURNS TABLE (
  ...
  sale_price DECIMAL,
  image_url TEXT,
  additional_images TEXT[],  -- Added for image carousel
  product_url TEXT,
  brand_id UUID,
  brand_name TEXT,
  brand_slug TEXT,
...
DO $$
BEGIN
  RAISE NOTICE 'Migration complete: added additional_images to get_recommendations';
  RAISE NOTICE 'ProductCard can now show image carousels in the Home feed';
END $$;
